...
const Promotion: React.FC<PromotionProps> = ({ }) => {
  return (
    <div className='h-[425px] text-white bg-[#2F6B4F] xl:py-[60px] md:py-[80px] xl:px-[389px]'>
      <h1 className='xl:text-[48px] text-[32px] font-bold text-center'>Have a project idea and <br />
